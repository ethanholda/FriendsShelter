  ...
  <tr> 
	...
	<table cellpadding="0" cellspacing="0" border="0" width="400">
        ...
        <tr> 
          ...
          <td class="welcome">&nbsp;Welcome, Administrator</td>
        </tr>
      </table></td>
...
<?
	...
	for ($i = 1;$i <= $days_in_month; $i++){
		$this_today=date("Y-m-d",mktime(0,0,0,$month,$i,$year));
		...
		if ($dbh->num_rows()<2) {
			echo "<a href=\"#\" onClick=\"MM_openBrWindow('add.php?d=$this_today&month=$month&year=$year','add','scrollbars=yes,resizable=yes,width=400,height=400')\"><img src=\"../images/add.gif\" width=\"88\" height=\"15\" border=\"0\"></a><br>";
		}
		
		while ($data=$dbh->next_record()) {
			echo $data->first_name." ".$data->last_name."<br>";
			echo "<a href=\"#\" onClick=\"MM_openBrWindow('delete.php?d=$this_today&month=$month&year=$year&user_id=".$data->user_id."&user_name=".urlencode($data->first_name." ".$data->last_name)."','add','scrollbars=no,resizable=yes,width=400,height=400')\"><img src=\"../images/delete.gif\" width=\"88\" height=\"15\" border=\"0\"></a><br>";
		}
