...
function checkForm(form) {
	...
	} else if (form.phone_home_in.value=="") {
...
<table width="700" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
		...
		<td colspan="2" class="title"><span class="blue">Add/Change Profile</span></td>
	...
	<tr>
		...
		<tr>
			...
			<td class="content" align="right"><b>Privacy Statement</b></td>
			<td>All information will be protected behind a password for shelter volunteers access only.  Your information will never be distributed outside the shelter for any reason.</td>
			...
			<tr>
				...
				<td><input class="profiletext" type="text" name="password_in" value="<? echo $data_user->password; ?>" size="24" maxlength="8"></td>
			...
			<tr>
				...
				<td><input class="profiletext" type="text" name="password_confirm_in" value="<? echo $data_user->password; ?>" size="24" maxlength="8"></td>
...
<td>&nbsp;</td>
		...
		<option value="home"<? if ($data_user->preferred_contact_method=="home") echo " selected"; ?>>home</option>
		...
		<option value="email"<? if ($data_user->preferred_contact_method=="email") echo " selected"; ?>>email</option>
			...
			<tr>
				...
				<td class="content">Your information will be stored inside the password-protected volunteer-only section of the website.  It will never be distributed outside the shelter for any reason.</td>
