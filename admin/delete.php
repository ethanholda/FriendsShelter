...
<table width="700" cellpadding="0" cellspacing="0" border="0">
    ...
    <td class="content"><p>I am about to delete <? echo $user_name; ?> for <? echo $d; ?>, is this correct? 
      </p>
      <table width="200" border="0" cellspacing="0" cellpadding="10">
        <tr>
          <td><a href="calendar.php?<? echo "delete_date=$d&month=$month&year=$year&user_id=$user_id"; ?>" target="calendar" onclick="window.close()"><img src="../images/yes.gif" width="82" height="15" border="0"></a></td>
          <td><a href="calendar.php?<? echo "month=$month&year=$year"; ?>" target="calendar" onclick="window.close()"><img src="../images/no.gif" width="85" height="15" border="0"></a></td>
        </tr>
      </table>
      <p>&nbsp; </p>
      <p>&nbsp;
