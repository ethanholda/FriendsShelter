...
<table width="700" cellpadding="0" cellspacing="0" border="0">
    ...
    <td colspan="2" class="title"><span class="blue">Delete Me</span></td>
    ...
    <td class="content"><p>I am about to delete you for <? echo $d; ?>, is this correct? 
<BR /><BR />
      
      NOTE: <BR />If this is within 4 days you MUST call Katy <BR />(212) 352-0957</p><BR /><BR />

      <table width="200" border="0" cellspacing="0" cellpadding="10">

        <tr>

          <td><a href="calendar.php?<? echo "delete_date=$d&month=$month&year=$year"; ?>" target="calendar" onclick="setTimeout('window.close()',1000)"><img src="images/yes.gif" width="82" height="15" border="0"></a></td>

          <td><a href="calendar.php?<? echo "month=$month&year=$year"; ?>" target="calendar" onclick="setTimeout('window.close()',1000)"><img src="images/no.gif" width="85" height="15" border="0"></a></td>
